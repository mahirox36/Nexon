...
class EphemeralCounter(nexon.ui.View):
    # When this button is pressed, it will respond with a Counter view that will
    # give the button presser their own personal button they can press 5 times.
    @nexon.ui.button(label="Click", style=nexon.ButtonStyle.blurple)
    async def receive(self, button: nexon.ui.Button, interaction: nexon.Interaction):
